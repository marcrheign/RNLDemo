  ...
  return (
    <>
      <div
        ...
        role="alert"
      >
        <div className="inline-flex items-center justify-center shrink-0 w-8 h-8 text-green-500 bg-green-200 rounded-lg transition-transform durataion-3oo ${isVisible ? 'translaye-y-0' : '-translate-y-10'}">
            <svg
  className="w-5 h-5"
  aria-hidden="true"
